CREATE DATABASE IF NOT EXISTS BD_SUPERMECADO_FUNCIONARIO_PRODUTO_CONSUMIDOR;
...
CREATE TABLE IF NOT EXISTS SUPERMECADO(
    ...
    SUP_EMAIL VARCHAR(2000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS FUNCIONARIO(
    ...
    FOREIGN KEY (FK_SUP_CNPJ) REFERENCES SUPERMECADO(SUP_CNPJ) ON DELETE CASCADE
);
