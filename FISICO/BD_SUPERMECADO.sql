CREATE DATABASE IF NOT EXISTS BD_SUPERMECADO_2ANO;
USE BD_SUPERMECADO_2ANO;
...
CREATE TABLE IF NOT EXISTS FUNCIONARIO(
    ...
    FK_SUPERMECADO_CNPJ VARCHAR(20) NOT NULL,
    FOREIGN KEY (FK_SUPERMECADO_CNPJ) REFERENCES SUPERMECADO(CNPJ)
);

CREATE TABLE IF NOT EXISTS SUPERMECADO_PRODUTO(
	ID INTEGER AUTO_INCREMENT PRIMARY KEY,
    FK_SUPERMECADO_CNPJ VARCHAR(20),
...
-- ALTERAR TABELA SUPERMECADO, MUDAR COLUNA TELEFONE
ALTER TABLE SUPERMECADO
CHANGE COLUMN TELEFONE TELEFONE_SUPERMECADO VARCHAR(15);

-- ALTERAR TABELA SUPERMECADO, MODIFICAR COLUNA LOGRADOURO
ALTER TABLE SUPERMECADO
...
DROP DATABASE BD_SUPERMECADO_2ANO;